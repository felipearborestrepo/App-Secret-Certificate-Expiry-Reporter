...
<#
.SYNOPSIS
    Entra ID - Service Principal Secret & Certificate Expiry Checker

.DESCRIPTION
    Scans all App Registrations for secrets and certificates expiring
    within 30, 60, or 90 days (or already expired).
    Outputs color-coded console results and exports a CSV report.
